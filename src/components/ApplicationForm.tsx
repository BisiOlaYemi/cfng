...
const ApplicationForm: React.FC = () => {
  ...
  //   { value: 'Weingarten', label: 'Weingarten (Germany)' },
  //   { value: 'Tampere', label: 'Tampere (Finland)' },
  //   { value: 'Eschenburg', label: 'Eschenburg (Germany)' },
  //   { value: 'Slavikov', label: 'Slavíkov (Czech)' },
  //   { value: 'Hamburg', label: 'Hamburg (Germany)' },
  //   { value: 'Enschede', label: 'Enschede (Netherlands)' },
  // ];
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4 pb-2 border-b border-gray-200">Event Selection</h2>
          {/* <RadioGroup
            label="Application for the event"
            name="event"
        ...
        <div className="mt-8">
          <button
            type="submit"
            className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-4 px-8 rounded-md shadow-md transition-all hover:shadow-lg transform hover:-translate-y-1"
          >
            Submit Application
          </button>
        </div>
